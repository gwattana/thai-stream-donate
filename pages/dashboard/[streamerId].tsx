...
export default function Dashboard({ streamerId }) {
  ...
  return (
    <>
      ...
      <div className="page">
        ...
        <aside className="sidebar">
          ...
          <nav>
            ...
            <a className="nav-item">💜 การสนับสนุน</a>
          </nav>
          <div className="sidebar-id">ID: {streamerId}</div>
        </aside>
        ...
        <main className="main">
          ...
          <section className="section">
            ...
            <div className="url-card">
              <div className="url-label">🖥 Overlay URL (ใส่ใน Streamlabs → Browser Source)</div>
              <div className="url-row">
              ...
              <p className="url-hint">
                ใน Streamlabs → Sources → Add → Browser Source → วาง URL นี้ → Width: 1920, Height: 1080 → Check "Shutdown source when not visible"
              </p>
            </div>
          </section>
      ...
      <style jsx>{`
        ...
        .donation-row:hover { background: rgba(255,255,255,0.07); }
        .donation-avatar {
          width: 40px;
          height: 40px;
          border-radius: 50%;
...
export async function getServerSideProps({ params }) {
  return { props: { streamerId: params.streamerId } }
}
